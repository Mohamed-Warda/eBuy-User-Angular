...
export class CheckoutComponent {
  ...
  choosenAddress:any;
   ...
   cartID:String="";
  constructor(
    private UserService: UserService,private CartService :CartService,private PaymentMethodsService :PaymentMethodsService,
  ) {}
  ngOnInit(): void {
...
sendAddress(addressID:any ){
 ...
 placeOrder(){
  ...
  const radioButtons = document.getElementsByName("payment") as NodeListOf<HTMLInputElement>;
  ...
  if(this.selectedMethod=="")
  {
    ...
    {
      this.PaymentMethodsService.cashOrder( this.choosenAddress,this.cartID).subscribe(res=>{
      ...
      this.PaymentMethodsService.cardOrder( this.choosenAddress,this.cartID).subscribe((res:any)=>{
